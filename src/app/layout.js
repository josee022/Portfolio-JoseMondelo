            ...
            <div className="hidden md:flex items-center space-x-12">
              <ul className="flex gap-10 text-base font-medium">
                ...
                >
                  ...
                  >
                    <span className="relative z-10 text-gray-300 group-hover:text-white transition-colors duration-300">Inicio</span>
                ...
                >
                  <Link
                    ...
                    className="relative cursor-pointer group transition-all duration-300 px-3 py-2 text-lg"
                  >
                    <span className="relative z-10 text-gray-300 group-hover:text-white transition-colors duration-300">Experiencia</span>
                    <span className="absolute left-0 bottom-0 w-0 group-hover:w-full h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300"></span>
                  </Link>
                </motion.li>
                ...
                <div className="bg-gray-900/95 backdrop-blur-md border-t border-blue-500/10 px-6 py-6">
                  <div className="flex flex-col space-y-5">
                    ...
                    >
                      ...
                      >
                        <span className="border-l-2 border-blue-500/50 pl-3">Inicio</span>
                      </Link>
                    </motion.div>
                    ...
                    >
                      <Link
                        ...
                        onClick={() => setIsMenuOpen(false)}
                      >
                        <span className="border-l-2 border-blue-500/50 pl-3">Experiencia</span>
                      </Link>
                    </motion.div>
